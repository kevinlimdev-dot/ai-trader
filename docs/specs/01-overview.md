...
5. **AI 스마트 익절**: 수익 포지션에 대해 OpenClaw AI가 시장 지표를 분석하여 동적 익절 판단. 프로그레시브 트레일링(수익↑ → 추적폭↓)으로 큰 수익 보호
...
│   ├── position-monitor.ts      # 독립 포지션 모니터 (15초 주기, 프로그레시브 트레일링 + AI 스마트 익절)
│   ├── services/
...
| **포지션 모니터** | 15초 주기 독립 프로세스, SL/TP/프로그레시브 트레일링/AI 스마트 익절 |
